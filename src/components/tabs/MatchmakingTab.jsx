...
import { Info, CheckCircle, SearchX, ShieldX, FileX, Loader2, AlertTriangle, AlertOctagon } from 'lucide-react';
  ...
  return (
    <div style={{ textAlign: 'center', padding: 40 }}>
      ...
      <button
        ...
        style={{ background: 'none', border: 'none', cursor: 'pointer', color: '#0066B8', fontSize: 14, fontWeight: 600 }}
      >
...
function AIPreState({ onGenerate, guestName }) {
  return (
    <div style={{ paddingTop: 64 }}>
      ...
      <div style={{ backgroundColor: '#F9FAFB', borderLeft: '4px solid #0066B8', border: '1px solid #E5E7EB', borderRadius: 6, padding: '16px 20px', marginBottom: 32 }}>
        <div style={{ display: 'flex', alignItems: 'flex-start', gap: 8 }}>
          <Info size={16} style={{ color: '#005A9E', flexShrink: 0, marginTop: 2 }} />
      ...
      <div style={{ textAlign: 'center' }}>
        <button
          onClick={onGenerate}
          style={{
            backgroundColor: '#0066B8', color: '#fff', border: 'none', borderRadius: 6,
    ...
    <div style={{ paddingTop: 32, display: 'flex', justifyContent: 'center' }}>
      <div style={{
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginBottom: 24 }}>
          <Loader2 size={32} style={{ color: '#0066B8', animation: 'spin 0.8s linear infinite', marginBottom: 16 }} />
...
function ViewAllHostsLink({ onClick }) {
  return (
    <div style={{ textAlign: 'center', marginTop: 16 }}>
      ...
      <button
        onClick={onClick}
        style={{ background: 'none', border: 'none', cursor: 'pointer', color: '#0066B8', fontSize: 14, fontWeight: 600, padding: 0 }}
      >
...
export default function MatchmakingTab({ applicant }) {
  ...
  const trustBanner = (
    <>
      <div style={{ backgroundColor: '#F9FAFB', borderLeft: '4px solid #0066B8', border: '1px solid #E5E7EB', borderRadius: 6, padding: '16px 20px', marginBottom: 16 }}>
        <div style={{ display: 'flex', alignItems: 'flex-start', gap: 8, marginBottom: 8 }}>
          <Info size={16} style={{ color: '#005A9E', flexShrink: 0, marginTop: 1 }} />
          <span style={{ fontWeight: 700, fontSize: 14, color: '#005A9E', lineHeight: 1.4 }}>These suggestions are generated by AI to support your decision. You make the final call.</span>
        </div>
        <p style={{ margin: 0, fontSize: 14, color: '#242424', lineHeight: 1.6 }}>
  ...
  return (
    <div style={{ flex: 1, overflowY: 'auto', padding: 24 }}>
          ...
          {!declinedHidden && data.declinedPairs?.map(dp => (
            <div key={dp.name} style={{ border: '1px solid #E5E7EB', borderRadius: 6, padding: 16, marginBottom: 12, backgroundColor: '#F9FAFB', opacity: 0.6 }}>
              ...
              <button
                ...
                style={{ background: 'none', border: 'none', cursor: 'pointer', color: '#0066B8', fontSize: 13, padding: 0 }}
              >
      ...
      {aiState === 'complete' && data.type === 'normalMatches' && skippedOnly && (
        <div style={{ textAlign: 'center', padding: 32, color: '#7C7C7C' }}>
          ...
          <div style={{ display: 'flex', gap: 8, justifyContent: 'center' }}>
            <button onClick={() => openHostGallery(selectedGuest.name)} style={{ border: '1px solid #0066B8', borderRadius: 6, padding: '7px 16px', fontSize: 13, background: '#fff', cursor: 'pointer', color: '#0066B8' }}>
              View All Hosts Manually
            </button>
            <button onClick={() => { setVisibleCards(null); setSkippedOnly(false); setAiState('idle'); setVisibleStepCount(0); }} style={{ backgroundColor: '#0066B8', color: '#fff', border: 'none', borderRadius: 6, padding: '7px 16px', fontSize: 13, fontWeight: 600, cursor: 'pointer' }}>
              Re-run AI Matching
            </button>
          </div>
        </div>
        ...
        <div style={{ paddingTop: 64 }}>
          <div style={{ textAlign: 'center', marginBottom: 20 }}>
            ...
            <div style={{ display: 'flex', gap: 8, justifyContent: 'center', marginBottom: 12 }}>
              ...
              <button onClick={() => openHostGallery(selectedGuest.name)} style={{ border: '1px solid #0066B8', borderRadius: 6, padding: '8px 20px', fontSize: 13, background: '#fff', cursor: 'pointer', color: '#0066B8' }}>
                View All Hosts Manually
              </button>
            </div>
          </div>
          <div style={{ maxWidth: 480, margin: '0 auto' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'flex-end', marginTop: 8 }}>
              <button
                ...
                style={{ backgroundColor: '#0066B8', color: '#fff', border: 'none', borderRadius: 6, padding: '7px 16px', fontSize: 13, fontWeight: 600, cursor: 'pointer' }}
              >
                Save Note
              </button>
            </div>
      ...
      {aiState === 'complete' && data.type === 'singleMatch' && showSingleSkipped && (
        <div style={{ textAlign: 'center', padding: 32, color: '#7C7C7C' }}>
          ...
          <div style={{ display: 'flex', gap: 8, justifyContent: 'center' }}>
            ...
            <button onClick={() => { setShowSingleSkipped(false); setVisibleCards(data.matches.map(m => m.id)); }} style={{ background: 'none', border: 'none', cursor: 'pointer', fontSize: 13, color: '#0066B8' }}>
              Go Back
            </button>
          </div>
        </div>
      ...
      {aiState === 'complete' && data.type === 'allRedFlags' && (
        <>
          <div style={{ backgroundColor: '#F9FAFB', borderLeft: '4px solid #DC2626', border: '1px solid #E5E7EB', borderRadius: 6, padding: '16px 20px', marginBottom: 16 }}>
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: 8, marginBottom: 8 }}>
              <AlertOctagon size={16} style={{ color: '#B91C1C', flexShrink: 0, marginTop: 2 }} />
              <span style={{ fontWeight: 700, fontSize: 14, color: '#B91C1C', lineHeight: 1.4 }}>All suggested matches have at least one incompatible criterion.</span>
            </div>
            <p style={{ margin: 0, fontSize: 14, color: '#242424', lineHeight: 1.6, paddingLeft: 24 }}>Proceed with caution and review each carefully. A written override will be required to confirm any of these matches.</p>
          </div>
          {trustBanner}
          {visibleMatches.map((match, i) => (
            <div key={match.id} style={{ animation: `fadeIn 0.4s ease ${i * 0.25}s both` }}>
      ...
      {aiState === 'complete' && data.type === 'noSafeMatches' && (
        <div>
          ...
          <div style={{ backgroundColor: '#F9FAFB', borderLeft: '4px solid #DC2626', border: '1px solid #E5E7EB', borderRadius: 6, padding: '16px 20px', marginBottom: 16 }}>
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: 8 }}>
              <AlertOctagon size={16} style={{ color: '#B91C1C', flexShrink: 0, marginTop: 2 }} />
              <span style={{ fontWeight: 700, fontSize: 14, color: '#B91C1C', lineHeight: 1.4 }}>{selectedGuest.name}'s profile requires an LGBTQ+-affirming host. No verified affirming hosts are currently available.</span>
            </div>
          </div>
          ...
          <div style={{ display: 'flex', gap: 8, justifyContent: 'center', marginBottom: 16 }}>
            <button onClick={() => setExpandedPool(e => !e)} style={{ border: '1px solid #0066B8', borderRadius: 6, padding: '7px 16px', fontSize: 13, background: '#fff', cursor: 'pointer', color: '#0066B8' }}>
              Expand Host Pool
            </button>
            <button onClick={goToDashboard} style={{ border: '1px solid #6B7280', borderRadius: 6, padding: '7px 16px', fontSize: 13, background: '#fff', cursor: 'pointer', color: '#6B7280' }}>
              Return to Dashboard
          ...
          {expandedPool && (
            <div style={{ backgroundColor: '#F9FAFB', borderLeft: '4px solid #0066B8', border: '1px solid #E5E7EB', borderRadius: 6, padding: '12px 16px', marginBottom: 16 }}>
              <p style={{ margin: 0, fontSize: 14, color: '#242424', lineHeight: 1.6 }}>Contact your program administrator to recruit LGBTQ+-affirming hosts. Currently affirming hosts available: 0</p>
            </div>
          )}
          <div>
            <p style={{ fontSize: 12, color: '#6B7280', marginBottom: 6 }}>Add a follow-up note for this case:</p>
      ...
      {aiState === 'complete' && data.type === 'insufficientData' && (
        <div style={{ paddingTop: 64 }}>
          ...
          <div style={{ backgroundColor: '#F9FAFB', borderLeft: '4px solid #D97706', border: '1px solid #E5E7EB', borderRadius: 6, padding: '16px 20px', marginBottom: 24, maxWidth: 480, margin: '0 auto 24px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 8 }}>
              <AlertTriangle size={16} style={{ color: '#92400E', flexShrink: 0 }} />
              <span style={{ fontWeight: 700, fontSize: 14, color: '#92400E', lineHeight: 1.4 }}>Missing or incomplete sections:</span>
            </div>
            <ul style={{ margin: 0, paddingLeft: 20, fontSize: 14, color: '#242424', lineHeight: 1.9 }}>
      ...
      {aiState === 'complete' && data.type === 'emptyPool' && (
        <div style={{ textAlign: 'center', padding: 32 }}>
          ...
          <div style={{ backgroundColor: '#F9FAFB', borderLeft: '4px solid #0066B8', border: '1px solid #E5E7EB', borderRadius: 6, padding: '16px 20px', marginBottom: 16, maxWidth: 480, marginLeft: 'auto', marginRight: 'auto' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 8 }}>
              <Info size={16} style={{ color: '#005A9E', flexShrink: 0 }} />
              <span style={{ fontWeight: 700, fontSize: 14, color: '#005A9E', lineHeight: 1.4 }}>This may mean:</span>
            </div>
            <ul style={{ margin: 0, paddingLeft: 20, fontSize: 14, color: '#242424', lineHeight: 1.8 }}>
        ...
        {!hasRedFlagsPending ? (
          <>
            ...
            <div style={{ display: 'flex', gap: 8 }}>
              <button onClick={() => setShowModal(false)} style={{ flex: 1, border: '1px solid #0066B8', borderRadius: 6, padding: '8px 0', fontSize: 13, background: '#fff', cursor: 'pointer', color: '#0066B8' }}>
                Cancel
              </button>
              <button onClick={finalizeMatch} style={{ flex: 1, backgroundColor: '#0066B8', color: '#fff', border: 'none', borderRadius: 6, padding: '8px 0', fontSize: 13, fontWeight: 600, cursor: 'pointer' }}>
                Confirm Match
              </button>
            </div>
          </>
